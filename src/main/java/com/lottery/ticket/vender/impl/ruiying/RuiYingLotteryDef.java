...
public class RuiYingLotteryDef {
	...
	public static void main(String[] args) {
		String str="300914005-20160619025(03)|20160619116(13,01,00)|20160619117(11,03)|20160620027(03,01)^";
		StringBuilder strBuilder=new StringBuilder();
		int playType=Integer.parseInt(str.split("-")[0]);
		String content = str.split("-")[1].replace("^", "").replace("(","=").replace(")","").replace(",","/").replace("|",",");
		String []cons=content.split("\\,");
		StringBuffer stringBuffer=new StringBuffer();
		int i=0;
		for(String con:cons){
