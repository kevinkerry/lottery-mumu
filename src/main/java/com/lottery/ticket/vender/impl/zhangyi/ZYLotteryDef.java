...
//		playTypeMap.put(PlayType.sd11c5_dr8.getValue(), "1");
		...
		playCodeMap.put(PlayType.jclq_mix_4_4.getValue(),"43");
		...
		playCodeMap.put(PlayType.ssq_dan.getValue(), "0");
 		...
 		//山东11x5
		playCodeMap.put(PlayType.sd11c5_sr2.getValue(), "2");
 		playCodeMap.put(PlayType.sd11c5_sr3.getValue(), "3");
 		playCodeMap.put(PlayType.sd11c5_sr4.getValue(), "4");
 		playCodeMap.put(PlayType.sd11c5_sr5.getValue(), "5");
		playCodeMap.put(PlayType.sd11c5_sr6.getValue(), "6");
		playCodeMap.put(PlayType.sd11c5_sr7.getValue(), "7");
		playCodeMap.put(PlayType.sd11c5_sr8.getValue(), "8");
		playCodeMap.put(PlayType.sd11c5_sq1.getValue(), "1");
		playCodeMap.put(PlayType.sd11c5_sq2.getValue(), "9");
		...
		playCodeMap.put(PlayType.sd11c5_mr2.getValue(), "2");
		playCodeMap.put(PlayType.sd11c5_mr3.getValue(), "3");
		playCodeMap.put(PlayType.sd11c5_mr4.getValue(), "4");
		playCodeMap.put(PlayType.sd11c5_mr5.getValue(), "5");
		playCodeMap.put(PlayType.sd11c5_mr6.getValue(), "6");
		playCodeMap.put(PlayType.sd11c5_mr7.getValue(), "7");
//		playCodeMap.put(PlayType.sd11c5_mr8.getValue(), "8");
//		playCodeMap.put(PlayType.sd11c5_mq1.getValue(), "1");
		playCodeMap.put(PlayType.sd11c5_mq2.getValue(), "9");
		...
		playCodeMap.put(PlayType.sd11c5_dr2.getValue(), "2");
		playCodeMap.put(PlayType.sd11c5_dr3.getValue(), "3");
		playCodeMap.put(PlayType.sd11c5_dr4.getValue(), "4");
		playCodeMap.put(PlayType.sd11c5_dr5.getValue(), "5");
		playCodeMap.put(PlayType.sd11c5_dr6.getValue(), "6");
		playCodeMap.put(PlayType.sd11c5_dr7.getValue(), "7");
//		playCodeMap.put(PlayType.sd11c5_dr8.getValue(), "8");
		...
		playCodeMap.put(PlayType.sd11c5_dz3.getValue(), "12");
			...
			playTypeToAdvanceConverterMap.put(PlayType.sd11c5_sq1,sd_11x5_ds);
