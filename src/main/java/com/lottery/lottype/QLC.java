...
import com.lottery.lottype.qlc.Qlc01;
import com.lottery.lottype.qlc.Qlc02;
import com.lottery.lottype.qlc.Qlc03;

@Component("1003")
public class QLC extends AbstractLot {


	private Logger logger = LoggerFactory.getLogger(QLC.class);
	
	Map<String, LotPlayType> map = new HashMap<String, LotPlayType>();
	{
		map.put("100301", new Qlc01());
		map.put("100302", new Qlc02());
		map.put("100303", new Qlc03());
	}
