...
public class JiangXi11c5 extends AbstractLot {
	...
	{
		map.put("200602", new Sd11x5SR2());
		map.put("200603", new Sd11x5SR3());
		map.put("200604", new Sd11x5SR4());
		map.put("200605", new Sd11x5SR5());
		map.put("200606", new Sd11x5SR6());
		map.put("200607", new Sd11x5SR7());
		map.put("200608", new Sd11x5SR8());
		map.put("200631", new Sd11x5SQ1());
		map.put("200632", new Sd11x5SQ2());
		map.put("200633", new Sd11x5SQ3());
		map.put("200634", new Sd11x5SZ2());
		map.put("200635", new Sd11x5SZ3());
		
		map.put("200612", new Sd11x5MR2());
		map.put("200613", new Sd11x5MR3());
		map.put("200614", new Sd11x5MR4());
		map.put("200615", new Sd11x5MR5());
		map.put("200616", new Sd11x5MR6());
		map.put("200617", new Sd11x5MR7());
		map.put("200618", new Sd11x5MR8());
		map.put("200641", new Sd11x5MQ1());
		map.put("200642", new Sd11x5MQ2());
		map.put("200643", new Sd11x5MQ3());
		map.put("200644", new Sd11x5MZ2());
		map.put("200645", new Sd11x5MZ3());
		
		map.put("200622", new Sd11x5DR2());
		map.put("200623", new Sd11x5DR3());
		map.put("200624", new Sd11x5DR4());
		map.put("200625", new Sd11x5DR5());
		map.put("200626", new Sd11x5DR6());
		map.put("200627", new Sd11x5DR7());
		map.put("200628", new Sd11x5DR8());
		map.put("200654", new Sd11x5DZ2());
		map.put("200655", new Sd11x5DZ3());
