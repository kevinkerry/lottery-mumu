...
import com.lottery.lottype.zc.jinqiu.Zucaijinqiu01;
import com.lottery.lottype.zc.jinqiu.Zucaijinqiu02;

@Component("4003")
public class Zcjqc extends AbstractLot{

	private Logger logger = LoggerFactory.getLogger(Zcjqc.class);
	
	
	Map<String, LotPlayType> map = new HashMap<String, LotPlayType>();
	{
		map.put("400301", new Zucaijinqiu01());
		map.put("400302", new Zucaijinqiu02());
	}
	...
	public List<SplitedLot> split(String betcode, int lotmulti, long amt,
		...
		long totalAmt = 0;
		if(isZcSingleUpload(betcode, String.valueOf(PlayType.zc_jqc_dan.value))) {
