...
import com.lottery.lottype.jc.guanyajun.JcGuanyajun01;

@Component("3013")
public class JcGuanyajun extends AbstractGuanyajunLot{
	
	private Logger logger = LoggerFactory.getLogger(JcGuanyajun.class);
	
	Map<String, LotPlayType> map = new HashMap<String, LotPlayType>();
	
	{
		map.put("301301", new JcGuanyajun01());
	}
	...
	public LotteryType getLotteryType() {
		return LotteryType.JC_GUANYAJUN;
	}
