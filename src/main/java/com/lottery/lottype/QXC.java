...
import com.lottery.lottype.qxc.Qxc01;
import com.lottery.lottype.qxc.Qxc02;

@Component("2004")
public class QXC extends AbstractLot{
	
	private Logger logger = LoggerFactory.getLogger(QXC.class);
	
	Map<String, LotPlayType> map = new HashMap<String, LotPlayType>();
	{
		map.put("200401", new Qxc01());
		map.put("200402", new Qxc02());
