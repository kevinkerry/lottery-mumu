...
public abstract class Nxk3X implements LotPlayType{

	protected int lotterytype = LotteryType.NXK3.value;
	
	protected static String k310 = "(100510)[-](([1-6])([,]([1-6])){2}[\\^])+";
	
	protected static String k311 = "(100511)[-]([1-6])([,]([1-6])){0,5}[\\^]";
	
	protected static String k312 = "(100512)[-]([1-6])([,]([1-6])){0,4}[*]([1-6])([,]([1-6])){0,4}[\\^]";
	
	protected static String k320 = "(100520)[-](([1-6])[,]([1-6])[\\^])+";
	
	protected static String k321 = "(100521)[-]([1-6])([,]([1-6])){2,5}[\\^]";
	
	protected static String k322 = "(100522)[-]([1-6])[#]([1-6])([,]([1-6])){1,4}[\\^]";
	
	protected static String k330 = "(100530)[-](([1-6])([,]([1-6])){2}[\\^])+";
	
	protected static String k340 = "(100540)[-](([1-6])([,]([1-6])){2}[\\^])+";
	
	protected static String k341 = "(100541)[-]([1-6])([,]([1-6])){3,5}[\\^]";
	
	protected static String k342 = "(100542)[-]([1-6])([,]([1-6])){0,1}[#]([1-6])([,]([1-6])){1,4}[\\^]";
	
	protected static String k360 = "(100560)[-]([4-9]|1[0-7])([,]([4-9]|1[0-7])){0,13}[\\^]";
