...
public class LotteryPhase implements Serializable {
	...
	private transient Date enableSaleTime;// 平台出票截止时间
	...
	public Date getEnableSaleTime() {
		return enableSaleTime;
	}

	public void setEnableSaleTime(Date enableSaleTime) {
		this.enableSaleTime = enableSaleTime;
	}
	...
	public String toString() {
		...
		sb.append(",期号：" + phase);
		sb.append(",平台截止时间:" + enableSaleTime);
