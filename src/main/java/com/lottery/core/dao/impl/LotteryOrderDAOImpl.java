...
public class LotteryOrderDAOImpl extends AbstractGenericDAO<LotteryOrder, String> implements LotteryOrderDAO {
	...
	@Override
	public void updateOrderResultStatus(String orderId, int orderResultstatus) {
		Map<String,Object> map=new HashMap<String,Object>();
		map.put("orderResultStatus", orderResultstatus);
		Map<String,Object> whereMap=new HashMap<String,Object>();
		whereMap.put("id", orderId);
	...
	public Long countNotPrize(int lotteryType, String phase) {
		String sql="select count(o) from LotteryOrder o where o.lotteryType=:lotteryType and o.phase=:phase and o.orderStatus in (:orderStatus) and o.orderResultStatus=:orderResultStatus";
		...
		total.setParameter("orderResultStatus", OrderResultStatus.not_open.value);
		return total.getSingleResult();
	}

	@Override
	public Long countNotEncash(int lotteryType, String phase) {
		String sql="select count(o) from LotteryOrder o where o.lotteryType=:lotteryType and o.phase=:phase and o.orderStatus in (:orderStatus) and o.orderResultStatus in(:orderResultStatus) and o.isExchanged=:isExchanged";
		TypedQuery<Long> total=getEntityManager().createQuery(sql,Long.class);
		total.setParameter("lotteryType", lotteryType);
		total.setParameter("phase", phase);
		List<Integer> statusList=new  ArrayList<Integer>();
	...
	@Override
	public int updateWincode(int lotteryType, String phase, String wincode) {
		Map<String, Object> conditionMap = new HashMap<String, Object>();
	...
	public List<Object[]> getByLotteryPhaseAndStatusForMonitor(Integer lotteryType, Date deadline, List<Integer> status) {
		String sql = "select orderStatus,phase,deadline,count(*), sum(amount) from LotteryOrder o where deadline > :deadline and o.lotteryType = :lotteryType and orderStatus in (:orderStatus) group by orderStatus,phase,deadline ";
	...
	@Override
	public List<Object[]> getByLotteryPhaseAndStatus(Integer lotteryType, String phase, Integer orderStatus, Integer max) {
		String sql = "select id, amount, deadline, receiveTime from LotteryOrder o where lotteryType = :lotteryType and phase = :phase and o.orderStatus = :orderStatus ";
		Query query = entityManager.createQuery(sql + " order by receiveTime asc");
		query.setParameter("lotteryType", lotteryType).setParameter("phase", phase).setParameter("orderStatus", orderStatus).setMaxResults(max);
		return query.getResultList();
	}
	
	@Override
	public Long getCountByLotteryPhaseAndStatus(Integer lotteryType, String phase, Integer orderStatus) {
		String sql = "select count(id) from LotteryOrder o where lotteryType = :lotteryType and phase = :phase and o.orderStatus = :orderStatus ";
		TypedQuery<Long> query = entityManager.createQuery(sql, Long.class);
		query.setParameter("lotteryType", lotteryType).setParameter("phase", phase).setParameter("orderStatus", orderStatus);
