...
public class LotteryPhaseService {
	 ...
	 * */
	@Transactional
	public int phaseSwitch(int phaseStatus, int forSale, int forCurrent,Long id){
		return dao.phaseSwitch(phaseStatus, forSale, forCurrent, id);
	}
	 ...
	 * */
	@Transactional
	public int phaseSwitch(int phaseStatus, int forSale, int forCurrent,int lotteryType, String phase){
		return dao.phaseSwitch(phaseStatus, forSale, forCurrent, lotteryType, phase);
	}
