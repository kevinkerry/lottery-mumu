...
public class MerchantService {
	 ...
	 * */
	@Transactional
	public Merchant save(String username, String password, String realname, String idCard, String mobilePhone, String ip, BigDecimal amount, String noticeUrl, Integer isNotice) {
