...
public class MerchantOrderService {
	 ...
	 * */
	@Transactional
	public MerchantOrder bet(String merchantCode, String merchantNo, String betcode, String orderId, int lotteryType, String phase, int playType, int multiple, int amount, int addition,int timeout,String endtime){
	MerchantOrder merchantOrder=betservice.merchantBet(merchantCode, merchantNo, betcode, orderId, lotteryType, phase, playType, multiple, amount, addition, endtime);
